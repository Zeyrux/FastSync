...
static void test_scanner_subdirectory() {
  ...
  DirectoryScanner* scanner =
      directory_scanner_create((char*)root, false, 0, NULL, 0, NULL, 0, 0, 0, 0, false, false, false, false);
  EXPECT_NOT_NULL(scanner);
...
static void test_scanner_exclude_pattern() {
  ...
  char* exclude[] = {"*.tmp"};
  DirectoryScanner* scanner =
      directory_scanner_create((char*)dir, false, 0, exclude, 1, NULL, 0, 0, 0, 0, false, false, false, false);
  EXPECT_NOT_NULL(scanner);
...
static void test_scanner_exclude_subdirectory() {
  ...
  char* exclude[] = {"*.tmp"};
  DirectoryScanner* scanner =
      directory_scanner_create((char*)root, false, 0, exclude, 1, NULL, 0, 0, 0, 0, false, false, false, false);
  EXPECT_NOT_NULL(scanner);
...
static void test_scanner_include_and_exclude() {
  ...
  DirectoryScanner* scanner =
      directory_scanner_create((char*)dir, false, 0, exclude, 1, include, 2, 0, 0, 0, false, false, false, false);
  EXPECT_NOT_NULL(scanner);
...
static void test_scanner_max_size() {
  ...
  DirectoryScanner* scanner =
      directory_scanner_create((char*)dir, false, 0, NULL, 0, NULL, 0, 10, 0, 0, false, false, false, false);
  EXPECT_NOT_NULL(scanner);
...
static void test_scanner_size_range() {
  ...
  DirectoryScanner* scanner =
      directory_scanner_create((char*)dir, false, 0, NULL, 0, NULL, 0, 20, 3, 0, false, false, false, false);
  EXPECT_NOT_NULL(scanner);
...
static void test_scanner_mixed_patterns() {
  ...
  char* include[] = {"*.txt"};
  DirectoryScanner* scanner =
      directory_scanner_create((char*)dir, false, 0, exclude, 1, include, 1, 10, 3, 0, false, false, false, false);
  EXPECT_NOT_NULL(scanner);
