...
|--------|-------|-------------|
| ✅ Parity | 108 | Reproduces rsync's semantics for this option's scope |
| ⚠️ Caveat | 24 | Wired and tested, but carries a documented behavioral difference from rsync (named in the row and/or the wave notes) |
